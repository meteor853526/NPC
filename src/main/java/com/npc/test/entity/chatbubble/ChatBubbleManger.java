...
public class ChatBubbleManger {
    ...
    public static void addChatBubble(long endTime, ChatText text, NpcEntity maid) {
...
//        }
    ...
    public static int getChatBubbleCount(NpcEntity maid) {
        int count = 0;
        MaidChatBubbles chatBubble = maid.getChatBubble();
        Pair<Long, ChatText> bubble1 = chatBubble.getBubble1();
        Pair<Long, ChatText> bubble2 = chatBubble.getBubble2();
...
//            }
    ...
    private static void checkTimeoutChatBubble(NpcEntity maid) {
        MaidChatBubbles chatBubble = maid.getChatBubble();
        Pair<Long, ChatText> bubble1 = chatBubble.getBubble1();
        Pair<Long, ChatText> bubble2 = chatBubble.getBubble2();
        Pair<Long, ChatText> bubble3 = chatBubble.getBubble3();
...
//    }
    ...
    private static void addMainChatText(NpcEntity maid) {
...
//        }
    ...
    private static void addMainChatText(NpcEntity maid, String chatText) {
...
//    private static void addWorkChatText(NpcEntity maid, String taskId) {
...
//    }
    ...
    private static List<ChatText> getChatTexts(NpcEntity maid, Function<ChatBubbleInfo.Text, List<ChatText>> function) {
